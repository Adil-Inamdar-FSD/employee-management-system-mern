...
const ChangePasswordModal = ({ open, onClose }) => {
  ...
  return (
    ...
    >
      <div className="absolute bg-black/40 inset-0 backdrop-sm-blur" />
      <div
      ...
      >
        <div className="flex items-center justify-between p-6 pb-0">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-lg hover:lg-slate-100 transition-colors text-slate-400 hover:text-slate-600"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
